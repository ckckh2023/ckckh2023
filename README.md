...
- **BTIR-脑肿瘤 MRI 图像分析** — 面向临床与科研的脑肿瘤 MRI 一站式分析平台，内置多用户隔离、异步任务队列与 3D 体渲染
- **TrashGo智识助手** — 集垃圾分类、人脸识别与图像信息识别于一体的智能工具
...
本人代码普遍遵循 MIT 协议；个人文案一般遵循 CC BY-NC-ND 4.0。欢迎复用我的任何代码，但禁止直接搬运站点内容或将仓库整体复制后作为自己的内容。
